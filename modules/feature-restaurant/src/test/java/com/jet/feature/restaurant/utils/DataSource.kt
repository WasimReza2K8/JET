...
val restaurant3 = restaurant0.copy(
    status = Open(),
    sortingValues = SortingValues(
        bestMatch = 1232.0,
        newest = 63.0,
...
val restaurant2 = restaurant0.copy(
    status = OrderAhead(),
    sortingValues = SortingValues(
        bestMatch = 1222.0,
        newest = 93.0,
...
val restaurant5 = restaurant0.copy(
    status = OrderAhead(),
    sortingValues = SortingValues(
        bestMatch = 220.0,
        newest = 193.0,
...
val restaurant1 = restaurant0.copy(
    status = Closed(),
    sortingValues = SortingValues(
        bestMatch = 12.0,
        newest = 9.0,
...
val restaurant4 = restaurant3.copy(
    status = Closed(),
    sortingValues = SortingValues(
        bestMatch = 1220.0,
        newest = 93.0,
...
val restaurantDto0 = RestaurantDto(
    id = "1",
    name = "Sushi Bar",
    status = "open",
...
val restaurantDto1 = restaurantDto0.copy(
    sortingValues = RestaurantDto.SortingValues(
        bestMatch = 1232.0,
        newest = 63.0,
        ratingAverage = 3.5,
