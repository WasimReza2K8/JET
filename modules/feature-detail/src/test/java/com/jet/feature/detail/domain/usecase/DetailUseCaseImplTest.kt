...
import com.example.feature.detail.utils.TestDispatcherProvider
import com.example.detail.domain.repository.DetailRepository
...
class DetailUseCaseImplTest {
    ...
    private val useCase: DetailUseCaseImpl = DetailUseCaseImpl(
